...
print("Lightning hits her", phone_brand, ". When the dust settles she realizes a very", height_type, "wizard is there!")
...
print("\nThe princess and the", height_type, "wizard are in the infirmary. The king and the queen send the castle wizard to check on them both.")
...
print("While", player_name, "and the princess wait they play games and eat snacks. They relax and enjoy the", sky_choice, "filled sky.")
print("The storm maybe gone, but a friendship is brewing!")
